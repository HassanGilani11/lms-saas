            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-4">
                    ...
                    {initialData?.lessons?.map((lesson: any) => (
                        <div key={lesson.id} className="border rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                            <div
                                className="flex items-center gap-x-2 p-4 hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition cursor-pointer"
                            ...
                            >
                                <div className="flex items-center gap-x-2 flex-1">
                                    ...
                                    <span className="font-bold text-slate-700 dark:text-slate-400 text-sm italic mr-2 uppercase tracking-widest text-[10px]">Lesson {lesson.position}</span>
                            ...
                            {expandedLessons[lesson.id] && (
                                <div className="px-4 pb-4 space-y-6 bg-slate-50/30 dark:bg-slate-900/30">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {editingProgression === lesson.id ? (
                                            <div className="space-y-4 bg-white dark:bg-slate-950 p-4 rounded-lg border border-slate-200 dark:border-slate-800 shadow-inner">
                                                    ...
                                                    <div className="space-y-2 pt-2 border-t border-slate-50 dark:border-slate-800">
                                                        ...
                                                        <div className="flex flex-wrap gap-2">
                                                            {progressionRules.map((rule) => (
                                                                <Badge key={rule} variant="outline" className="flex items-center gap-x-1.5 px-2 py-1 bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 text-[11px] hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                                                                    {rule === "COMPLETED_PREVIOUS" ? "Complete Previous Lesson" : rule}
                                                                    <button
                                                                        type="button"
                                                                        onClick={(e) => {
                                                                        ...
                                                                        className="ml-1 rounded-full p-0.5 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-400 hover:text-rose-500 transition-colors"
                                                                    >
                                                                        <X className="h-3 w-3" />
                                                                    </button>
                                                                </Badge>
                                            ...
                                            <div className="flex flex-wrap gap-2 items-center min-h-[40px] bg-white/50 dark:bg-slate-950/50 p-2 rounded-xl border border-dashed border-slate-200 dark:border-slate-800">
                                                {lesson.progressionRules && lesson.progressionRules.length > 0 ? (
                                                    lesson.progressionRules.map((rule: string) => (
                                                        <Badge key={rule} variant="secondary" className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 border-none px-2 py-0.5 text-[11px] font-medium">
                                                            {rule === "COMPLETED_PREVIOUS" ? "Complete Previous Lesson" : rule}
                                                        </Badge>
                                                    ))
                                                ) : (
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {isCreatingTopic === lesson.id && (
                                            <div className="flex items-center gap-x-2 p-3 bg-white dark:bg-slate-900 border dark:border-slate-800 rounded-lg shadow-sm">
                                                <Input
                                                ...
                                                {creationMode === "TOPIC" ? (
                                                    <select
                                                        ...
                                                        className="h-8 text-xs bg-slate-50 dark:bg-slate-800 px-2 rounded-md border-none ring-1 ring-slate-200 dark:ring-slate-700"
                                                    >
                                        ...
                                        <div className="space-y-4">
                                            {lesson.topics?.map((topic: any, index: number) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between p-3 group hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition">
                                                            <div className="flex items-center gap-x-3">
                                                                ...
                                                                <span className="text-[13px] font-semibold text-slate-700 dark:text-slate-200">{topic.title}</span>
                                                            </div>
                                                                ...
                                                                {topic.type === "QUIZ" ? (
                                                                    <Button
                                                                        ...
                                                                        onClick={(e) => {
                                                                            e.stopPropagation();
                                                                            if (topic.quizId) {
                                                                                router.push(`/instructor/quizzes/${topic.quizId}`);
                                                                            } else {
                                                        ...
                                                        {editingTopicId === topic.id && (
                                                            <div className="p-4 border-t dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 space-y-4">
                                                                <div className="space-y-2">
                                                                    <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Text Content / Description</label>
                                                                    <textarea
                                                                        className="w-full text-sm p-4 border dark:border-slate-800 rounded-xl min-h-[150px] bg-white dark:bg-slate-950 resize-none focus:ring-1 focus:ring-slate-400 dark:focus:ring-slate-700 outline-none shadow-sm dark:text-slate-200"
                                                                ...
                                                                {topic.type === "VIDEO" && (
                                                                    <div className="space-y-2">
                                                                        ...
                                                                        <Input
                                                                            className="h-10 bg-white dark:bg-slate-950 dark:border-slate-800"
                                                                            value={editTopicUrl}
                                                                ...
                                                                <div className="flex gap-x-2 pt-2">
                                                                    ...
                                                                    <Button type="button" onClick={() => setEditingTopicId(null)} variant="outline" size="sm" className="h-9 px-4 text-xs font-bold dark:border-slate-800">
                                                                        Cancel
                                                                    </Button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="px-4 pb-3 pt-1 space-y-2 bg-slate-50/10">
                                                            {isAddingAttachment === topic.id && (
                                                                <div className="flex flex-col gap-y-2 p-2 border dark:border-slate-800 rounded bg-white dark:bg-slate-950 mt-1">
                                                                    <Input
                                                            ...
                                                            {topic.attachments?.map((attachment: any) => (
                                                                <div key={attachment.id} className="flex items-center justify-between text-[11px] text-slate-500 bg-white dark:bg-slate-950 px-2 py-1 rounded border border-slate-50 dark:border-slate-800 group/attachment">
                                                                    <div className="flex items-center gap-x-2">
                                                                        <File className="h-3 w-3 text-slate-400" />
                                                                        <a href={attachment.url} target="_blank" className="hover:underline text-slate-600 dark:text-slate-400">{attachment.name}</a>
                                                                    </div>
                                                                    <Button
                                                                        type="button"
