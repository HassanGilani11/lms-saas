...
import { getInstructorCourses, deleteCourse } from "@/actions/course";
...
const InstructorCoursesPage = () => {
    ...
    return (
        <div className="text-slate-900 dark:text-slate-100 font-sans space-y-6 animate-in fade-in duration-500">
            <div className="flex items-center justify-between">
                <h1 className="text-[17px] font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
            ...
            <Card className="border-none shadow-sm overflow-hidden bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
                <CardHeader className="px-6 py-4 border-b border-slate-200/50 dark:border-slate-800/50">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="relative group">
                            ...
                            <Input
                                ...
                                className="h-8 w-64 pl-9 bg-slate-50/50 dark:bg-slate-950/50 border-none dark:border-slate-800 text-[13px] dark:text-slate-200 focus-visible:ring-1 focus-visible:ring-slate-200 dark:focus-visible:ring-slate-700 placeholder:text-slate-400 dark:placeholder:text-slate-500"
                            />
                        </div>
                    </div>
                </CardHeader>
                <CardContent className="p-0">
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-slate-50/50 dark:bg-slate-900/50 hover:bg-slate-50/50 dark:hover:bg-slate-900/50 border-b border-slate-200/50 dark:border-slate-800/50 text-[11px] uppercase tracking-tighter">
                                <TableHead className="pl-6 font-bold text-slate-400 dark:text-slate-500">Name</TableHead>
                                <TableHead className="font-bold text-slate-400 dark:text-slate-500">Category</TableHead>
                                <TableHead className="font-bold text-slate-400 dark:text-slate-500 text-center">Date</TableHead>
                                <TableHead className="font-bold text-slate-400 dark:text-slate-500 text-center">Status</TableHead>
                                <TableHead className="text-right pr-6 font-bold text-slate-400 dark:text-slate-500">Options</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {filteredCourses.map((course) => (
                                <TableRow
                                    key={course.id}
                                    className="group hover:bg-slate-50/50 dark:hover:bg-slate-900/50 border-b border-slate-200/50 dark:border-slate-800/50 last:border-0 cursor-pointer transition-colors"
